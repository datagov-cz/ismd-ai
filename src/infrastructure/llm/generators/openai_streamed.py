...
from domain.models.suggestion_model import GlobalClassSuggestion, LocalClassSuggestion, LangString, GlobalAttributeSuggestion, GlobalRelationshipSuggestion, LegalAct, LegalStructuralElement
...
from infrastructure.llm.schemas.generated_suggestions_model import (
  LocalSemanticModel,
...
class SuggestionGenerator_OpenAI_Streamed(SuggestionGeneratorPort):
    ...
    async def generate_top_k_class_suggestions(
        ...
        from infrastructure.llm.schemas.generated_suggestions_model import ClassExtractionResult
    ...
    async def generate_top_k_property_suggestions_for_class(
        ...
        buffer = ''
        import json as _json
        from infrastructure.llm.schemas.generated_suggestions_model import PropertyExtractionResult
        pattern = re.compile(r'}\s*,\s*\{|}\s*]')
