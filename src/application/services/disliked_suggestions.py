...
from infrastructure.persistence.evaluations.suggestion_evaluations import SuggestionEvaluationRepository
...
class DislikedSuggestionService:
    ...
    def dislike(self, job_id: UUID, suggestion_id: str, user_id: str) -> None:
        self._ensure_owned_suggestion(job_id, suggestion_id, user_id)
        self.repo.record_suggestion_dislike(job_id, suggestion_id, user_id)
