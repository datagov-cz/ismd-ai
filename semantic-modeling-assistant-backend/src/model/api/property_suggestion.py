...
class StartPropertySuggestionsJobResponse(BaseModel):
    ...
    selected_class_id: UUID = Field(description="The ID of the class for which property suggestions are to be generated")
...
class PropertySuggestionsJobStatusResponse(BaseModel):
    ...
    selected_class_id: UUID = Field(description="The ID of the class for which property suggestions are being generated")
